...
```{r, message = FALSE}
data <- read_xlsx("C:\\Users\\jenny\\OneDrive - University of Pittsburgh\\Desktop\\Reg Analysis\\M1\\M1 Lab\\hwdata1.xlsx") %>%
...
summary(model_mmolL)
ggRegression(model_mmolL, title = "Plot of HDL by Cholesterol (mmol/L)")
```
