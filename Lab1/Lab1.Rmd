...
```{r}
# Change working directory to proper folder
...
#knitr::include_app("https://vpkjjn-matthewep528.shinyapps.io/lab1-shiny-test-2/")
#a (mostly failed) shiny app I was testing
...
```{r}
# fit MLR model
MLR <- lm(HDL ~ triglyceride + cholesterol + spbl, data = data)
summ(MLR)
