...
# fit lasso (you'll need to choose the approproate alpha value)



# fit ridge (you'll need to choose the approproate alpha value)
...
# stepAIC for backward selection uses the same syntax as a regular lm model so you can use 
# my.model$coefficients for a model fit with stepAIC
